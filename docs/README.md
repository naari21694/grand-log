...
Guides for running, configuring, and deploying Grand Log. New here? Start with the project
[README](../README.md) for what it is, then come back here for the details.

- [INSTALL.md](INSTALL.md): get it running locally, then run the bot, the dashboard, and backfill.
...
[SECURITY.md](../SECURITY.md) (the hardening checklist), [CONTRIBUTING.md](../CONTRIBUTING.md),
